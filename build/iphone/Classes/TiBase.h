...
// in simulator we redefine to format for Drupanium Developer console
...
{\
	NSString * exceptionName = [@"org.drupanium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.drupanium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIDrupaniumNativeItemNone = -1, 
	UIDrupaniumNativeItemSpinner = -2,
	UIDrupaniumNativeItemProgressBar = -3,
	
	UIDrupaniumNativeItemSlider = -4,
	UIDrupaniumNativeItemSwitch = -5,
	UIDrupaniumNativeItemMultiButton = -6,
	UIDrupaniumNativeItemSegmented = -7,
	
	UIDrupaniumNativeItemTextView = -8,
	UIDrupaniumNativeItemTextField = -9,
	UIDrupaniumNativeItemSearchBar = -10,
	
	UIDrupaniumNativeItemPicker = -11,
	UIDrupaniumNativeItemDatePicker = -12,
	
	UIDrupaniumNativeItemInfoLight = -13,
	UIDrupaniumNativeItemInfoDark = -14,
	
	UIDrupaniumNativeItemDisclosure = -15,
	
	UIDrupaniumNativeItemContactAdd = -16
};
